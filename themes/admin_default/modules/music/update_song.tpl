		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				<tr>
					...
					<td><input class="form-control" type="text" name="song_name" value="{DATA.song_name}" maxlength="250"/>
					<!-- BEGIN: error_song -->{error_song}<!-- END: error_song -->
					</td>
				</tr>
				<tr>
					<td><strong>{LANG.path}</strong></td>
					<td><input class="form-control" type="text" name="path" value="{DATA.path}" maxlength="250"/></td>
				</tr>
					<tr>
					<td><strong>{LANG.singer_sub}</strong></td>
					<td><select class="form-control w200" name = "parentid" id ="parent id " value="{DATA.path}"></select></td>
				</tr>
			
				<tr>
					<td><strong>{LANG.cat_sub}</strong></td>
					<td><select class="form-control w200" name = "parentid" id ="parent id" value="{DATA.cat_id}"></select></td>
				</tr>
